...
public enum CardType {
    ...
    static Pattern regVisa = Pattern.compile("^4[0-9]{12}(?:[0-9]{3})?$");
    static Pattern regMasterCard = Pattern.compile("^5[1-5][0-9]{14}$");
    static Pattern regAmericanExpress = Pattern.compile("^3[47][0-9]{13}$");
